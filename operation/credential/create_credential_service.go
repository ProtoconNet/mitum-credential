...
func (fact CreateCredentialServiceFact) Currency() currencytypes.CurrencyID {
...
func NewCreateCredentialService(fact CreateCredentialServiceFact) (CreateCredentialService, error) {
	return CreateCredentialService{BaseOperation: common.NewBaseOperation(CreateCredentialServiceHint, fact)}, nil
}
